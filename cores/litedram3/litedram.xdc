...
set_property IN_TERM NONE [get_ports {ddram_dq[1]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[2]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[3]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[4]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[5]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[6]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[7]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[8]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[9]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[10]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[11]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[12]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[13]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[14]}]
...
set_property IN_TERM NONE [get_ports {ddram_dq[15]}]
...
set_property IN_TERM NONE [get_ports {ddram_dqs_p[0]}]
...
set_property IN_TERM NONE [get_ports {ddram_dqs_n[0]}]
...
set_property IN_TERM NONE [get_ports {ddram_dqs_p[1]}]
...
set_property IN_TERM NONE [get_ports {ddram_dqs_n[1]}]
...
set_property PACKAGE_PIN P5 [get_ports {ddram_clk_p}]; #IO_L21P_T3_DQS_35 Sch=ddram_clk_p[0]

# PadFunction: IO_L21N_T3_DQS_35 
set_property SLEW FAST [get_ports {ddram_clk_n}]
set_property IOSTANDARD DIFF_SSTL15 [get_ports {ddram_clk_n}]
set_property PACKAGE_PIN P4 [get_ports {ddram_clk_n}]; #IO_L21N_T3_DQS_35 Sch=ddram_clk_n[0]
